...
def _run_cli() -> None:
    ...
    if len(sys.argv) < 2 or sys.argv[1] in ("-h", "--help", "-?"):
        ...
        print("    --token-budget N        per-chunk token cap for semantic extraction (default: 120000;")
        print("                            keeps large files whole on ~200k models, raise for 1M-context models)")
        ...
        print("    --no-gitignore         ignore .gitignore and .git/info/exclude (the default; prioritizes .graphifyignore)")
        print("    --gitignore            honor .gitignore and .git/info/exclude as well")
        print("                           both modes are recorded and reused by update/watch/hook rebuilds")
        print("    --no-cluster            skip clustering, write raw extraction only")
