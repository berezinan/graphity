...
def test_bsl_migrated():
    # Fork delta: BSL (1C/OneScript) + 1C:EDT extractors live in extractors/bsl.py,
    # and both the facade and the registry point at those objects.
    ...
    assert facade.extract_bsl is extract_bsl
    assert LANGUAGE_EXTRACTORS["bsl"] is extract_bsl
    for lang, fn in {
        ...
        assert LANGUAGE_EXTRACTORS[lang] is fn
