...
The data access layer has been redesigned: the GraphBackend abstraction has been introduced, and graph storage in ArcadeDB has been implemented (improving memory efficiency by a factor of 300).
